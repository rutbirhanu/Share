...
//usecase
getit.registerLazySingleton(() => GetHouseList(houseRepository: getit()));

//repository
getit.registerLazySingleton(() => HouseRepositoryImpl(houseRemoteDatasource: getit()));

//datasource
getit.registerLazySingleton(() => HouseRemoteDatasourceImpl(client: getit()));
